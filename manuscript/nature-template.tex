...
population (Cabrera and Rowe 2025).
...
We provide all the required aggregate process data on a Github
repository hosted via Open Science Framework
{[}\href{https://doi.org/10.17605/OSF.IO/U7Y3J}{https://doi.org/10.17605/osf.io/u7y3j}{]},
to reproduce the results reported in the paper. The other data used in
our analysis are openly available online for download: WorldPop data can
be obtained from \url{https://www.worldpop.org}; UNHCR data on refugees
...
of The University of Liverpool - Approval number: 15585 dated
22/01/2025. The approval covers the use of mobile phone data to generate
dynamic population displacement estimates in conflict regions. To
protect individual privacy, all analyses were conducted on aggregated
data, and robust data protection measures were employed to mitigate
risks of re-identification, in accordance with the EU General Data
Protection Regulation (GDPR).

\section{Informed consent}\label{informed-consent}

Informed consent was given by the data service providers at the point of
download of the respective data they used to share their location. Users
adhere to the terms of use, which includes a clause on the voluntary
sharing of their location live location for commercial and research
purposes at this point. Users can deactivate this function when they
desire.

\section{Author contributions}\label{author-contributions}

F.R. and E.P. devised the project and developed the main conceptual
ideas. F.R. R.I. and E.P. discussed the technical details of the study.
E.P. secured the data. F.R., R.I. and E.P. performed the numerical
calculations and data visualisation. F.R., R.I. and E.P. wrote the first
draft and discussed the results. F.R. and E.P. revised the manuscript.
F.R., R.I. and E.P. approved the final version.~
...
repository registered on the Open Science Framework with DOI
{[}\href{https://doi.org/10.17605/OSF.IO/U7Y3J}{https://doi.org/10.17605/osf.io/u7y3j}{]}.
We adopted an open and reproducible research approach based on the use
of open software. We used the R language in RStudio and followed best
practices in geographic data science (Arribas-Bel et al. 2021).
...
\bibitem[\citeproctext]{ref-cabrera2025}
Cabrera, Carmen, and Francisco Rowe. 2025. {``A Systematic Machine
Learning Approach to Measure and Assess Biases in Mobile Phone
Population Data.''} \url{https://doi.org/10.48550/arxiv.2509.02603}.
